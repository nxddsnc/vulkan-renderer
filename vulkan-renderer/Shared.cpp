...
uint32_t FindMemoryTypeIndex(vk::PhysicalDeviceMemoryProperties * gpuMemoryProperties,
	const vk::MemoryRequirements * memoryRequiremenets, const vk::MemoryPropertyFlags requiredProperties)
{
