...
public:
    ...
    void InitVulkanBuffers(std::shared_ptr<SingleDrawable> drawable);
    void InitVulkanResource(std::shared_ptr<SingleDrawable> drawable);
    ...
    void CreateVertexBuffers(std::shared_ptr<SingleDrawable> drawable);
...
private:
    void _createTextures(std::shared_ptr<SingleDrawable> drawable);
